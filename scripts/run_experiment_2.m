function results = run_experiment_2()
    ...
    for i = 1:length(train_img_ids)
        ...
        img_path = sprintf('saved_images/train_%d.png', train_img_ids(i));
    ...
    for i = 1:length(validate_img_ids)
        ...
        img = preprocess_img(img);
        img_path = sprintf('saved_images/val_%d.png', validate_img_ids(i));
        imwrite(img, img_path);
    ...
    for i = 1:length(test_img_ids)
        ...
        img = preprocess_img(img);
        img_path = sprintf('saved_images/test_%d.png', test_img_ids(i));
        imwrite(img, img_path);
    ...
    title("Experiment 2 - CNN Confusion Matrix");
