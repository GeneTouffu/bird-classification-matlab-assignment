function results = run_experiment_3()
    ...
    bow = build_vocabulary(train_img_ids, labels, 100, 1);

    [X_train, y_train] = extract_bow_sift(train_img_ids, labels, bow, 1);
    [X_val, y_val]     = extract_bow_sift(validate_img_ids, labels, bow, 1);
    [X_test, y_test]   = extract_bow_sift(test_img_ids, labels, bow, 1);
